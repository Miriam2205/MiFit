...
export const Consejos = () =>{
    ...
    return(
        <div className="Consejos-container">
            <h1 className="titulo">15 Consejos para mejorar el entrenamiento</h1>
            ...
            <h3 className="subtitulo">Ejercicios de movilidad y estiramientos</h3>
            ...
            <h3 className="subtitulo">6.Establece objetivos realistas</h3>
            ...
            <h3 className="subtitulo">7.Duerme suficiente</h3>
            ...
            <h3 className="subtitulo">8. Conexión cuerpo-mente</h3>
            ...
            <h3 className="subtitulo">9. No subestimes la dieta</h3>
            ...
            <h3 className="subtitulo">10.Date una recompensa</h3>
            ...
            <h3 className="subtitulo">11. Siéntete cómodo con lo que llevas puesto</h3>
            ...
            <h3 className="subtitulo">12. No te compares con otros</h3>
            ...
            <h3 className="subtitulo">13.Sigue una rutina estructurada</h3>
            ...
            <h3 className="subtitulo">14.Alimentación post-entreno</h3>
            ...
            <h3 className="subtitulo">Ejercicios básicos</h3>
